...
<html lang="en">
	...
	<meta charset="utf-8">
		...
		<title>Smartphones - Electro.</title>
	</head>
	<body>
		<!-- HEADER -->
		<header>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<?php
							$sql = "SELECT discount, image, category, price, after_the_discount, products FROM fornend_database_products WHERE category = 'smartphones' LIMIT 3";
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							<?php
								$sql = "SELECT discount, image, category, price, after_the_discount, products FROM fornend_database_products WHERE category = 'smartphones' LIMIT 50";
								$result = $conn->query($sql);
