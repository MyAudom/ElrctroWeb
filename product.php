                                        ...
                                        <?php
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    if (!empty($image_path) && file_exists($_SERVER['DOCUMENT_ROOT'] . "/Admin/image_upload/" . basename($image_path))) {
                                                        echo "<td><img src='/Admin/image_upload/" . basename($image_path) . "' alt='Product Image' style='width: 100px; height: auto;'></td>";
                                                    } else {
                                                ...
                                                if ($image_stmt) {
                                                    ...
                                                    if ($image_stmt->execute()) {
                                                        ...
                                                        if ($image_result->num_rows > 0) {
                                                            ...
                                                            $image_full_path = $_SERVER['DOCUMENT_ROOT'] . "/Admin/image_upload/" . basename($image_path);
