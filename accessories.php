...
<html lang="en">
	...
	<head>
		...
		<title>Accessories - Electro.</title>
	</head>
	<body>
		<!-- HEADER -->
		<header>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="labtop.php">Laptops</a></li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<?php
							$sql = "SELECT discount, image, category, price, after_the_discount, products FROM fornend_database_products WHERE category = 'accessories' LIMIT 3";
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							<?php
								$sql = "SELECT discount, image, category, price, after_the_discount, products FROM fornend_database_products WHERE category = 'accessories' LIMIT 50";
								$result = $conn->query($sql);
